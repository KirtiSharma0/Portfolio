            ...
            <div className='md:flex flex-wrap flex-col md:flex-row items-center'>
                ...
                <ul>
                    <div className='flex gap-3 py-4'>
                        ...
                        <div><img src = "/frontend.jpeg" className='w-40 h-40 mx-20 rounded-full'></img></div>
                    </div>
                    ...
                    <div className='flex gap-3 py-4'>
                        ...
                        <div><img src = "/backend.jpeg" className='w-40 h-40 mx-20 rounded-full'></img></div>
                    </div>
                    ...
                    <div className='flex gap-3 py-4'>
                        ...
                        <div><img src = "/graphic.jpeg" className='w-40 h-40 mx-20 rounded-full'></img></div>
                    </div>
                </ul>
            </div>
        </div>
